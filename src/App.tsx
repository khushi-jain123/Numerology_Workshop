  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://images.pexels.com/photos/1252890/pexels-photo-1252890.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`,
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-purple-400">Numerology Mastery</span>
            </div>
          ...
          {isMenuOpen && (
            <motion.div
              ...
              className="md:hidden mt-4 py-4 border-t border-purple-500/30"
            >
              {navItems.map((item) => (
                <button
                  key={item.name}
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 pt-20">
        <div className="text-center max-w-6xl mx-auto relative z-10">
          <motion.h1
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-400 via-purple-500 to-violet-600 bg-clip-text text-transparent"
            style={{
          ...
          >
            <button
              ...
              className="bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 text-white font-bold py-4 px-8 rounded-full text-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
              style={{
          ...
          <motion.div
            ...
            className="mt-12"
          >
            <p className="text-red-400 text-lg font-semibold mb-4 animate-pulse">
              ⚡ Offer ends tonight! ⚡
            </p>
            <CountdownTimer />
          </motion.div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-12">
            ...
            >
              <div className="relative">
                <img
                  ...
                  alt="Ankiit Batra"
                  className="w-80 h-80 rounded-full object-cover mx-auto border-4 border-purple-500 shadow-2xl"
                  style={{
                    boxShadow: '0 0 50px rgba(147, 51, 234, 0.3)',
                  }}
                />
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-purple-500/20 to-violet-600/20"></div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="lg:w-2/3"
            >
              <h3 className="text-3xl font-bold text-purple-400 mb-4">Ankiit Batra</h3>
      ...
      {/* Learnings Section */}
      <section id="learnings" className="py-20 px-4 bg-gradient-to-b from-black to-gray-900 relative z-10">
        <div className="container mx-auto max-w-6xl">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl border border-purple-500/30 hover:border-purple-500/60 transition-all duration-300 hover:transform hover:scale-105"
                style={{
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="bg-gradient-to-br from-purple-500/10 to-violet-600/10 p-6 rounded-xl border-2 border-purple-500/50 hover:border-purple-500 transition-all duration-300"
                style={{
                  boxShadow: '0 0 30px rgba(147, 51, 234, 0.1)',
                }}
              >
                <div className="flex items-start space-x-4">
                  <div className="text-purple-400 flex-shrink-0">{bonus.icon}</div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-xl font-semibold text-white">{bonus.title}</h3>
      ...
      {/* Reviews Section */}
      <section id="reviews" className="py-20 px-4 bg-gradient-to-b from-gray-900 to-black relative z-10">
        <div className="container mx-auto max-w-6xl">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section id="register" className="py-20 px-4 relative z-10">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-2xl border-2 border-purple-500/50 mb-8 max-w-lg mx-auto">
              <div className="text-center">
                <p className="text-gray-400 text-lg line-through mb-2">Regular Price: ₹497</p>
                <p className="text-5xl font-bold text-purple-400 mb-4">₹97</p>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 text-white font-bold py-6 px-12 rounded-full text-2xl shadow-2xl transition-all duration-300 mb-6 inline-flex items-center space-x-3"
              style={{
      ...
      {/* FAQ Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-black to-gray-900 relative z-10">
        <div className="container mx-auto max-w-6xl">
          <FAQ />
        </div>
      </section>
      ...
      {/* Sticky Footer */}
      <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-black/70 to-black/20 p-4 z-50 shadow-2xl">
        <div className="container mx-auto flex items-center justify-between">
          <div className="text-white font-semibold">
            <span className="hidden md:inline">Limited Time: ₹97 Only - </span>
            <span className="text-sm">Offer ends tonight!</span>
          </div>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => scrollToSection('register')}
            className="bg-black text-purple-400 font-bold py-2 px-6 rounded-full hover:bg-gray-900 transition-colors"
          >
            Join Now
          </motion.button>
        </div>
